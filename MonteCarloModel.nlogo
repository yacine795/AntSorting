...
globals [colorTab]                   ;; tableau des nourritures disponnibles dans l'environnement
...
to move                                                                                                ;|
  ...
  if (can-move? 1)[                                                                                    ;|
    fd 1 memoire                        ;; chaque fois que la fourmi avance elle fait appel a la fonction
  ]                                                                                                    ;|
end                                                                                                    ;|
;;#######################################################################################################
...
to pickup                                                                                              ;|
  if ((pcolor != 0) and (length tab > 0))[                                                             ;|
    ...
    if (random-float 1.0 < ((k+ / (k+ + f)) ^ 2))[                                                     ;|
      set color pcolor set pcolor 0 set charge? true                                                   ;|
    ]                                                                                                  ;|
  ]                                                                                                    ;|
end                                                                                                    ;|
;;#######################################################################################################
